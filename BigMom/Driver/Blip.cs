...
namespace BigMom.Driver
{
    public class Blip
    {
        ...
        public void Login()
        {
            ...
            _wait.Until(ExpectedConditions.VisibilityOfAllElementsLocatedBy(By.Id("navbar")));
        }
        ...
        private async void AddTeam(string user)
        {
            ...
            //save
            _driver.FindElement(By.XPath(@"/html/body/div[7]/div[2]/div[2]/form/div[2]/button[2]")).Click();
        }
